...
export namespace engine {
	...
	export class TrackURLOverride {
	    num: number;
	    url: string;
	
	    static createFrom(source: any = {}) {
	        return new TrackURLOverride(source);
	    }
	...
	export class BulkQueueEntry {
	    ...
	    track_url_overrides?: TrackURLOverride[];
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.track_url_overrides = this.convertValues(source["track_url_overrides"], TrackURLOverride);
	    }
